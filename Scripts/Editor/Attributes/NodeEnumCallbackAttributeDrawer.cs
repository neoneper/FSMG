...
using XNodeEditor;   namespace FSMGEditor
{
    ...
    public class NodeEnumCallbackAttributeDrawer : PropertyDrawer
    {
        ...
        public void EnumPopup(Rect position, SerializedProperty property, GUIContent label)
        {
        ...
        public void ShowContextMenuAtMouse(SerializedProperty property)
        {
            // Initialize menu
        ...
        {
            NodeEnumCallbackAttribute attr = (NodeEnumCallbackAttribute)attribute;
            object target = PropertyUtility.GetTargetObjectWithProperty(property);

            property.enumValueIndex = index;
            property.serializedObject.ApplyModifiedProperties();
            property.serializedObject.Update();
            MethodInfo callbackMethod = ReflectionUtility.GetMethod(target, attr.callbackName);

            InvoKeCallback(callbackMethod, property, target);
        }
        private void InvoKeCallback(MethodInfo callbackMethod, SerializedProperty property, object target)
        {
